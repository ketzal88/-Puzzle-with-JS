...
var instrucciones = [
"Mueve las flechas de tu teclado para acomodar los cuadrados en los lugares correctos", 
"Puedes ver como debe lucir el rompecabezas completo en la imagen de tu izquierda",
 "Ayudate con el espacio vacio para encontrar la solucion"];
...
function chequearSiGano() {
    //recorra la variable grilla y devuelva true si estan ordenadas o false desordenadas
    ...
    for(var i = 0; i < grillaganadora.length; i++) {
      resultado = resultado && (JSON.stringify(grilla[i]) === JSON.stringify(grillaganadora[i]));
   }
   return resultado;
}
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  var valorUno = grilla[filaPos1][columnaPos1];
  var valorDos = grilla[filaPos2][columnaPos2];
  grilla[filaPos1][columnaPos1] = valorDos;
  grilla[filaPos2][columnaPos2] = valorUno;
}
